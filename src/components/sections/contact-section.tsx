            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Горячая линия</span>
                </div>
              ...
              <a
                href="mailto:help@pravopomosh.ru"
                className={`group block transition-all duration-700 ${
                  isVisible ? "translate-x-0 opacity-100" : "-translate-x-16 opacity-0"
                }`}
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div
                ...
                style={{ transitionDelay: "500ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Ваша ситуация</label>
                <textarea
                  rows={3}
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Заявка отправлена! Свяжемся в течение 15 минут.</p>
                )}
              </div>
            </form>
          </div>
